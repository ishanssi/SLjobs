...
public class webviewactivity extends AppCompatActivity implements AdvancedWebView.Listener  {
    private static String TEST_PAGE_URL;// = "https://www.example.org/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //CirclesLoadingView cc= (CirclesLoadingView)findViewById(R.id.cc) ;


        ProgressDialog progressDialogload = new ProgressDialog(this);
